...
export function LoginScreen(props: LoginScreenProps): React.JSX.Element {
  const model = useMemo(() => new LoginScreenModel(props.authController), [props.authController]);
      ...
      <View style={styles.card}>
        ...
        <View style={styles.buttonWrap}>
          {state.submitting ? (
            ...
            <Button title='Login' onPress={onSubmit} disabled={!model.canSubmit()} />
          )}
        </View>

        <View style={styles.linkWrap}>
          <Text style={styles.link} onPress={() => props.onNavigate('Register')}>
