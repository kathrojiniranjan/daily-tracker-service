        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultPrice = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyItems_Users_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_DailyItems_DailyItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyItems_Name",
                table: "DailyItems",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_DailyItems_OwnerUserId",
                table: "DailyItems",
                column: "OwnerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_DailyItemId",
                table: "Transactions",
                column: "DailyItemId");
